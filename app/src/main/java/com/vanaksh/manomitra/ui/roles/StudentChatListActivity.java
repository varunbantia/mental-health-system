...
public class StudentChatListActivity extends AppCompatActivity {

    private RecyclerView rvChats;
    private StudentChatListAdapter adapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_view_appointments); // Reusing layout for consistency
    ...
    private void setupToolbar() {
        ...
        if (getSupportActionBar() != null) {
            getSupportActionBar().setTitle("My Support Chats 💬");
    ...
    private void initViews() {
        ...
        adapter = new StudentChatListAdapter(chatSessions);
                    ...
                    if (snapshots != null) {
                        ...
                        Collections.sort(chatSessions, (s1, s2) -> {
                            if (s1.getLastMessageTimestamp() == null || s2.getLastMessageTimestamp() == null)
                                return 0;
                            return s2.getLastMessageTimestamp().compareTo(s1.getLastMessageTimestamp());
                        });
                    }
